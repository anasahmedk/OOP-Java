...
public class Main {
    ...
    private static CommandoImpl createCommando(final String[] tokens) {
        int id = Integer.parseInt(tokens[1]);
        String firstName = tokens[2];
        String lastName = tokens[3];
    ...
    private static EngineerImpl createEngineer(final String[] tokens) {
        int id = Integer.parseInt(tokens[1]);
        String firstName = tokens[2];
        String lastName = tokens[3];
        double salary = Double.parseDouble(tokens[4]);
    ...
    private static LieutenantGeneralImpl createLieutenantGeneral(final String[] tokens) {
        int id = Integer.parseInt(tokens[1]);
        String firstName = tokens[2];
        String lastName = tokens[3];
        double salary = Double.parseDouble(tokens[4]);
    ...
    private static PrivateImpl createPrivate(final String[] tokens) {
        int id = Integer.parseInt(tokens[1]);
        String firstName = tokens[2];
        String lastName = tokens[3];
        double salary = Double.parseDouble(tokens[4]);
